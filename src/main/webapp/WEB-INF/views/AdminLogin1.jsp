				...
				<div id="login-column" class="col-md-6">
					<div id="login-box" class="col-md-12" role="form">
						<form:form id="login-form" class="form" method="POST"
							action="/adminfinal" modelAttribute="AdminLogin">
							<h3 class="text-center text-info">Admin Login</h3>
							<div class="form-group">
								<sf:label for="username" class="text-info" path="userId">Username:</sf:label>
								<br>
								<div>
									<sf:input type="text" name="username" path="userId"
							...
							<div class="form-group">
								<sf:label for="password" path="pass" class="text-info">Password:</sf:label>
								<br>
								<div>
									<sf:input type="text" path="pass" placeholder="Enter the Password"
							...
							<div id="register-link" class="text-right">
								<a href="userdata" class="text-info">Register User</a><br>
